...
#define EEPROM_RF_ENCRYPTION_AES_IV_ADDRESS (EEPROM_RF_ENCRYPTION_AES_KEY_ADDRESS+32)
#define EEPROM_NODE_LOCK_COUNTER (EEPROM_RF_ENCRYPTION_AES_IV_ADDRESS+8)
